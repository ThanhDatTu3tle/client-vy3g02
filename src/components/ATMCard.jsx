					...
					<CardBody>
						<ul className="m-0 text-muted">
							<li className="list-check">
								<small>
									Thẻ thanh toán phải do ngân hàng
									nội địa phát hành và đã được kích
									hoạt chức năng thanh toán trực
									tuyến
								</small>
							</li>
							<li className="list-check">
								<small>
									...
									<a
										href="https://www.traveloka.com/vi-vn/explore/tips/huong-dan-thanh-toan-qua-atm/57838"
										className="ms-1"
									>
										tại đây
									</a>
